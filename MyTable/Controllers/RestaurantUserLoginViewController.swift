//
//  RestaurantUserLoginViewController.swift
//  MyTable
//
...
class RestaurantUserLoginViewController: UIViewController, UITextFieldDelegate {
    ...
    func validateUser(){
        ...
        let searchUrl = URL(string: "http://ec2-18-194-249-203.eu-central-1.compute.amazonaws.com:8080/restaurant/login")!
        ...
        AF.request(searchUrl, method: .post, parameters: params).responseJSON { response in
            ...
            if(response.response!.statusCode == 200){
                ...
                DispatchQueue.main.async{
                    ...
                    self.saveLoggedInRestaurantUser()
                }
    ...
    func saveLoggedInRestaurantUser(){
        if(restaurantUser != nil){
            ...
            performSegue(withIdentifier: "segueRestaurantLoginToMainMenu", sender: self)
